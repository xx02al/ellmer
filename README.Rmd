...
insert_cassette("README", match_requests_on = c("uri", "body"))
...
chat <- chat_openai(
  ...
  # Force more reproducible answers
  params = params(seed = 123, temperature = 0)
)
```
...
The most programmatic way to chat is to create the chat object inside a function. By doing so, live streaming is automatically suppressed and `$chat()` returns the result as a nicely formatted string:

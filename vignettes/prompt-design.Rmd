...
```{r, include = FALSE}
has_keys <- ellmer:::openai_key_exists() && ellmer:::anthropic_key_exists()
has_cassette <- file.exists("prompt-design.yml")
...
library(vcr)
insert_cassette("prompt-design", match_requests_on = c("uri", "body"))
